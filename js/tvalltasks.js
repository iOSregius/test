(function($) {
	...
	var UserInputView = Backbone.View.extend({
		...
		addToHelloCollection : function(e) {
			var hello = new Hello({
				//name : this.$('input').val()
				conquest : this.$('#conquest').val(),
				con_desc : this.$('#con_desc').val(),
				tvshows : this.$('#tvshows').val()
	...
	var HelloView = Backbone.View.extend({
		...
		render : function() {
			...
			$(this.el).html('Hello ' + this.model.get('con_desc'));
			$(this.el).html('Hello ' + this.model.get('tvshows'));
			...
			conquestTasks.save({conquest: this.model.get('conquest'),con_desc: this.model.get('con_desc'),tvshows: this.model.get('tvshows')}, {
